        ...
        <div className="mt-2 grid grid-cols-2 gap-2">
          <button
            ...
            className={`rounded-lg border px-3 py-2 text-sm ${
              rol === "COMPRADOR" ? "border-gray-900 bg-gray-900 text-white" : "border-gray-300 text-gray-700"
            }`}
          >
            Quiero buscar inmuebles
          </button>
          <button
            type="button"
            onClick={() => setRol("PROPIETARIO")}
            className={`rounded-lg border px-3 py-2 text-sm ${
              rol === "PROPIETARIO" ? "border-gray-900 bg-gray-900 text-white" : "border-gray-300 text-gray-700"
            }`}
          >
            Quiero publicar inmuebles
          </button>
        </div>
        <p className="mt-1 text-xs text-gray-400">
          Podrás hacer ambas cosas más adelante, esto solo personaliza tu experiencia.
        </p>
      </div>
